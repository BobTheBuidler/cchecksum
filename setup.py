...
setup(
    ...
    ext_modules=cythonize([extension], compiler_directives={"language_level": 3, "embedsignature": True, "linetrace": False, "cdivision": True, "initializedcheck": False, "nonecheck": False, "wraparound": False}),
    zip_safe=False,
)
